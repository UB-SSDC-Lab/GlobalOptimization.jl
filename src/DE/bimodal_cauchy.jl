# The following it taken from BlackBoxOptim.jl: /src/bimodal_cauchy_distribution.jl
...
function rand(distr::BimodalCauchy)
    while true
...
function rand!(distr::BimodalCauchy, A::AbstractArray)
