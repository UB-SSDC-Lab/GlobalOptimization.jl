abstract type AbstractExitFlag end
struct Converged <: AbstractExitFlag end
struct HitIterationLimit <: AbstractExitFlag end
struct HitTimeLimit <: AbstractExitFlag end

struct Results{T <: AbstractFloat, XT <: AbstractArray, EF <: AbstractExitFlag}
    fbest::T
    xbest::XT
